...
, isClearCell: function (pos) {
    ...
    var noUnits = this._units.filter(filterByLocation(pos)).length === 0
    return withinBounds && noUnits
  }
, addUnit: function (unit, location) {
    var id, ncells = this._boardSize.x * this._boardSize.y
...
// make a new object that forwards to the real object
