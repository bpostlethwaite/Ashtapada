...
module.exports = function (receiver, status, userAttributes) {
  ...
  util.forward(receiver, [ 'getHealth'
                         , 'getLocation'
                         , 'joinBoard'
                         , 'leaveBoard'], status)
  ...
  util.forward(receiver, ['move', 'handCombat'], status)

  return util.extend(receiver, userAttributes)
}
